<x-app-layout>
    <div class="flex justify-center items-center w-full min-h-screen bg-gray-900">
        <div
            ...
            <form method="POST" action="{{ route('update', $passwords->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="flex-row p-4 mb-4 rounded-2xl border border-gray-100 dark:border-white">
                    ...
                    <div class="flex justify-between items-center mt-10 mb-4"">
                        ...
                        <button type="sumbit" name="action" value="generate"
                    ...
                    @if (isset($pass))
                        <div class="flex flex-row justify-center items-center mt-10 mb-4"">
                            <input type="text" placeholder="" name="password" value="{{ $pass }}"
                ...
                <div class="flex flex-row justify-center items-center mt-10 mb-4"">
                    <button type="sumbit" name="action" value="save"
                        class="py-2 px-4 m-10 text-white bg-purple-600 rounded-lg hover:bg-purple-700">Update</button>
                </div>
            </form>
        </div>
    </div>
